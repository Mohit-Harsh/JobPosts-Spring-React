                    ...
                    <div className="col-8" style={{padding:"2vw 2vw 2vw 2vw"}}>
                        ...
                        <div className="container" style={{display:"block",height:"fit-content",backgroundColor:"white", boxShadow:"0px 4px 8px 2px rgb(230,230,230",borderRadius:"0.5vw", border:"none"}}>
                            <div className="row" style={{display:"flex",backgroundColor:"rgb(30,30,30)",color:"white",padding:"1vw", justifyContent:"start", alignItems:"center"}}>
                                ...
                                <button onClick={handleText} style={{backgroundColor:!mark?'rgb(50,50,50)':'transparent',color:"white",border:"none", height:"fit-content", width:"fit-content", fontSize:"0.8vw", borderRadius:'5px'}}>TEXT</button>
                                <button onClick={handlePreview} style={{backgroundColor:mark?'rgb(50,50,50)':'transparent',color:"white",border:"none", height:"fit-content", width:"fit-content", fontSize:"0.8vw", borderRadius:'5px'}}>PREVIEW</button>
